...
public class GestionTachesApplication {
    ...
    CommandLineRunner commandLineRunner(IAccountService accountService)
    {
        ...
        accountService.addUser("user","123","user@gmail.com","amal","benmosbeh","ML engineer", 3000L,"USER");
        accountService.addUser("admin","123","adminr@gmail.com","dorra","chaouch","data engineer",5000L,"ADMIN");
     };
    }*/
